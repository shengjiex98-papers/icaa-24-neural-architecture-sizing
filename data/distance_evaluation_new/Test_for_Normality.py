...
# Load data
data = pd.read_csv('result_0430_mobilenetv3_small.txt', sep=';', header=None,
                   names=['File', 'Class', 'IOU Threshold', 'GT Dist', 'Pred Dist', 'Pred-gt', 'Absolute Relative Error',
                          'GT Box 1', 'GT Box 2', 'GT Box 3', 'GT Box 4', 'Pred Box 1', 'Pred Box 2', 'Pred Box 3', 'Pred Box 4'])
